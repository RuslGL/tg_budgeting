...
- category: строка из списка категорий (выбери наиболее подходящую), "unknown" если не подходит ни одна
- date: дата в формате YYYY-MM-DD, сегодня если не указана явно
